...
(async () => {
  ...
  await ok('a hyphen alone is not an alias', () => {
  ...
  await ok('an alias prices off its base index', () => {
  ...
  await ok('an alias inherits base fees and status', () => {
  ...
  console.log('\nboost isolation');
  await ok('BOOST twins are isolated-only', () => {
